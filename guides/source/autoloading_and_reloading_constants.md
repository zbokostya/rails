...
In this option, we eager load these few files on boot and reload regardless of whether the STI is used. Unless your application has a lot of STIs, this won't have any measurable impact.
